...
set(MSG_I_FLAGS "-Istd_msgs:/opt/miniconda3/envs/ros/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/Users/vasilisskarleas/Library/Mobile Documents/com~apple~CloudDocs/Documents/University Sorbonne/4th year/S7/Computer science for robotics/ROS/catkin_cc/src/submarinedrone/srv/depth_warning.srv" NAME_WE)
add_custom_target(_submarinedrone_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "submarinedrone" "/Users/vasilisskarleas/Library/Mobile Documents/com~apple~CloudDocs/Documents/University Sorbonne/4th year/S7/Computer science for robotics/ROS/catkin_cc/src/submarinedrone/srv/depth_warning.srv" ""
)
...
_generate_srv_cpp(submarinedrone
  "/Users/vasilisskarleas/Library/Mobile Documents/com~apple~CloudDocs/Documents/University Sorbonne/4th year/S7/Computer science for robotics/ROS/catkin_cc/src/submarinedrone/srv/depth_warning.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/submarinedrone)
  install(CODE "execute_process(COMMAND \"/opt/miniconda3/envs/ros/bin/python3.11\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/submarinedrone\")")
  # install generated code
  install(
